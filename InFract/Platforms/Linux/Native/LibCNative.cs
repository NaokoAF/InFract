...
public static unsafe partial class LibCNative
{
	...
	public const int ENOSYS = 38; // Invalid system call number
	...
	public const int EFSBADCRC = EBADMSG; // Bad CRC detected
	...
	public const int EFSCORRUPTED = EUCLEAN; // Filesystem is corrupted
